...
class TreeSitterService {
    ...
    parse(document) {
        ...
        const enabled = config.get('enableTreeSitter', true);
        if (!enabled) {
        ...
        const cached = (0, parseCache_1.getCachedParse)(uri, text);
        if (cached)
            return { ir: cached, errors: cached.errors };
        ...
        try {
            const { extractIR } = require('./astExtract');
            ...
            ir.errors = errors;
            (0, parseCache_1.setCachedParse)(uri, text, ir);
            return { ir, errors };
        }
        catch (err) {
...
exports.treeSitterService = new TreeSitterService();
//# sourceMappingURL=treeSitterService.js.map